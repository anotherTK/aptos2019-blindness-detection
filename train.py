...
from cls_bm.solver import make_lr_scheduler
from cls_bm.solver import make_optimizer
from cls_bm.engine.inference import inference
from cls_bm.engine.trainer import do_train
...
from cls_bm.utils.miscellaneous import mkdir, save_config
...
def main():
    ...
    logger = setup_logger("cls_bm", output_dir, get_rank())
